        ...
        <div className="flexCenter w-full sm:w-1/2 ">
          <form className="flex flex-col items-center w-[90%] sm:max-w-md m-auto gap-y-5 text-gray-800">
            ...
            <div className="w-full flex flex-col gap-y-3 medium-14">
              <div className="underline cursor-pointer hover:text-secondaryOne">
                Forgot your password
              </div>
              {currState === "Login" ? (
                <div className=" ">
                  <span className="underline cursor-pointer hover:text-secondaryOne">
                    Don't have account?
                  </span>

                  <span
                    onClick={() => setCurrState("Sign Up")}
                    className="underline cursor-pointer hover:text-secondaryOne ml-2"
                  >
                    Create account
                  </span>
                </div>
